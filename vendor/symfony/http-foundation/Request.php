...
class Request
{
     ...
     *
     *  * http://localhost/hello.php         returns an empty string
     *  * http://localhost/hello.php/page    returns an empty string
     *  * http://localhost/web/hello.php     returns '/web'
     *  * http://localhost/we%20b/hello.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
